...
class CSVParser:
    ...
    EXPECTED_COLUMNS = {
        'tweet_id': ['Tweet ID', 'Tweet ID', 'tweet_id', 'id'],
        ...
        'retweet_count': ['Retweets', 'retweets', 'Retweet count', 'retweet_count', 'retweets_count'],
    ...
    def parse_row(self, row: List[str], row_number: int, user_id: str) -> TweetEngagement:
        ...
        try:
            ...
            return TweetEngagement(
                ...
                engagement_score=0,  # Will be calculated later in T03
        ...
        try:
            ...
            for row_number, row in enumerate(csv_reader, start=2):  # Start at 2 (after header)
                ...
                try:
                    ...
                    # Error already recorded in parse_errors
                    continue
